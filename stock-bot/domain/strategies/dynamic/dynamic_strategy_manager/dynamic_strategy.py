    ...
    def _create_technical_detector(self, detector_name: str, detector_config: Dict[str, Any]):
        ...
        try:
            detector_class_mapping = {
                "rsi": "domain.signals.detectors.momentum.rsi_detector.RSISignalDetector",
                "macd": "domain.signals.detectors.trend_following.macd_detector.MACDSignalDetector",
                "sma": "domain.signals.detectors.trend_following.sma_detector.SMASignalDetector",
                "stoch": "domain.signals.detectors.momentum.stoch_detector.StochSignalDetector",
                "adx": "domain.signals.detectors.trend_following.adx_detector.ADXSignalDetector",
                "volume": "domain.signals.detectors.volume.volume_detector.VolumeSignalDetector",
                "bb": "domain.signals.detectors.volatility.bb_detector.BBSignalDetector"
            }
