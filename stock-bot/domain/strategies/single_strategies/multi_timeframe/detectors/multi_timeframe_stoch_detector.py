# MultiTimeframeStochDetector (다중 시간대 Stoch 래퍼 Detector)
# =========================================================
# - MultiTimeframeStrategy에서 Stoch 신호 감지를 별도 관리/확장/오버라이드 용도로 래핑한 클래스
# - 기본 StochSignalDetector의 기능을 그대로 상속하며, 가중치만 전달(로직은 동일)
...
class MultiTimeframeStochDetector(StochSignalDetector):
    """
    MultiTimeframeStrategy에서 Stoch 신호 감지를 담당하는 래퍼 Detector.
