...
class MarketIndicatorType(str, enum.Enum):
    ...
    # Fear & Greed Index의 7대 구성 요소
    FEAR_GREED_JUNK_BOND_DEMAND = "FEAR_GREED_JUNK_BOND_DEMAND"
    FEAR_GREED_MARKET_MOMENTUM = "FEAR_GREED_MARKET_MOMENTUM"
    FEAR_GREED_MARKET_VOLATILITY = "FEAR_GREED_MARKET_VOLATILITY"
    FEAR_GREED_PUT_CALL_OPTIONS = "FEAR_GREED_PUT_CALL_OPTIONS"
    FEAR_GREED_SAFE_HAVEN_DEMAND = "FEAR_GREED_SAFE_HAVEN_DEMAND"
    FEAR_GREED_STOCK_PRICE_BREADTH = "FEAR_GREED_STOCK_PRICE_BREADTH"
    FEAR_GREED_STOCK_PRICE_STRENGTH = "FEAR_GREED_STOCK_PRICE_STRENGTH"
