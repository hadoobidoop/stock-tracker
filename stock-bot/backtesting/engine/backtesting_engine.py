...
from domain.indicators.calculator import calculate_all_indicators, calculate_fibonacci_levels
    ...
    def _initialize_signal_service(self):
        ...
        if self.signal_service:
            try:
                ...
                all_strategies = [StrategyType(name) for name in strategy_names]
